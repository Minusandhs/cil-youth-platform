      ...
      <header style={{
        ...
        <div className="rsp-header-pad" style={{
          ...
          <div className="rsp-header-cil" style={{
            background:'var(--color-brand-accent-lt)',
          ...
          <div className="rsp-header-title-wrap">
            ...
            <div className="rsp-header-sub" style={{fontSize:'11px', color:'var(--color-text-on-dark)'}}>
            ...
            <div className="rsp-tabs rsp-tabs-desktop">
              {tabs.map(tab => (
                <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{
                  ...
                  borderBottom: activeTab === tab.id ? '2px solid var(--color-brand-accent-lt)' : '2px solid transparent',
